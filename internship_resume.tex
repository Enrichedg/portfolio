...
\begin{itemize}
\item Sized carbon-fiber wing spars under 2.5\,g loads (ANSYS FEA), designed payload-release hardware with ASME Y14.5 GD\&T, and compared XFLR5/ANSYS CFD predictions with flight telemetry.
\item Supporting Mission~3 and ground-mission work on the Structures and Test subteam for WashU's AIAA Design/Build/Fly aircraft.
\end{itemize}
\section{Leadership \& Communication Experience}
\role{Teaching Assistant}{Washington University in St.\ Louis}{St.\ Louis}{MO}{Aug. 2025 -- Present}
\begin{itemize}
\item Grade assignments and hold office hours for Vibrations (Aug.\ 2026 -- Present) and MEMS 2000 (Circuits) (Aug.\ 2025 -- Dec.\ 2025).
\end{itemize}
% \section{Projects}
